...
const VideoGrid = ({
  ...
  return (
    <div className="flex-1 w-full flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div
        className={`w-full grid gap-3 sm:gap-4 ${getGridClass()} max-h-[calc(100vh-140px)] transition-all duration-300`}
      >
        {/* Local User */}
        <VideoTile
          stream={localStream}
